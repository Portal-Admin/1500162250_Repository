// ==UserScript==
// @name     yi5-v4: Inserting additional note in ProfileView.do
// @version  1
// @grant    none
// ==/UserScript==
...
document.addEventListener('DOMContentLoaded', function(){
    ...
    var node = document.getElementById('profileDetails');
    if (!node) {
        var elements = document.getElementsByClassName('lotusTabContainer');
        if (elements) {
            node = elements[0];
        }
    }
